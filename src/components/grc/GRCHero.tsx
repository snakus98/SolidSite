...
import GRCHeroVisual from "@/components/grc/GRCHeroVisual";
    ...
    >
      ...
      <Container className="flex flex-col md:flex-row items-center gap-8 md:gap-8">
        ...
        <div className="flex-1 md:max-w-[44%] animate-fade-up">
          ...
          >
            GRC solution for modern governance, risk, and compliance
          </h1>

          <p className="text-[14px] sm:text-[15px] text-[var(--text-secondary)] leading-relaxed mb-8 max-w-[560px]">
            Bring policies, risks, controls, audits, evidence, and regulatory obligations into one
            operating model. We help organisations align ISO 27001, NIS2, GDPR, and SOC 2 requirements
            with practical workflows, clear ownership, and board-ready reporting.
          </p>
          ...
          >
            ...
            Book a 30-min GRC consultation
          </Link>
        </div>
