...
const STEPS = [
  { Icon: IconPeople, accent: CYAN, text: "Share your scope, obligations, and operating realities." },
  { Icon: IconRoadmap, accent: PURPLE, text: "We map a phased roadmap covering risks, controls, evidence, and reporting." },
  { Icon: IconDocCheck, accent: CYAN, text: "Leave with a costed proposal and practical next steps your leadership can support." },
];
...
export default function GRCCTA() {
  return (
    <section className="py-12 md:py-16" aria-labelledby="grc-cta-heading">
      <Container>
          ...
          <div className="rounded-large bg-[#040b1e] px-7 py-9 md:py-12 md:pl-7 md:pr-12">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
              ...
              <div className="flex flex-col border-l-2 border-[var(--purple)] pl-6">
                ...
                >
                  Plan your GRC roadmap with specialists who connect governance, risk, and compliance.
                </h2>
              ...
              <div className="lg:border-l lg:border-[var(--border-default)] lg:pl-12">
                ...
                <form className="space-y-5">
                  <div>
                    <label htmlFor="grc-name" className="block text-[14px] text-[var(--text-secondary)] mb-2">Full name</label>
                    <input id="grc-name" name="name" type="text" placeholder="Enter your full name" className={inputCls} />
                  </div>
                  <div>
                    <label htmlFor="grc-email" className="block text-[14px] text-[var(--text-secondary)] mb-2">Work email</label>
                    <input id="grc-email" name="email" type="email" placeholder="Enter your work email" className={inputCls} />
                  </div>
                  <div>
                    <label htmlFor="grc-session" className="block text-[14px] text-[var(--text-secondary)] mb-2">Book a session</label>
                    <div className="relative">
                      <select id="grc-session" name="session" defaultValue="" className={`${inputCls} appearance-none pr-10 cursor-pointer`}>
