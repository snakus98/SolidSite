...
function IconResilience({ c }: IconProps) {
  return (
    <svg viewBox="0 0 48 48" className="w-full h-full">
      <path d="M24 6 L38 11 V23 C38 33 24 42 24 42 C24 42 10 33 10 23 V11 Z" {...S(c)} />
      <path d="M16 23 h5 l2 -5 l3 9 l2 -4 h4" {...S(c)} strokeWidth={1.9} />
    </svg>
  );
}
...
const CORE = [
  { Icon: IconResilience, accent: CYAN, title: "Cyber resilience & critical systems protection", desc: "Protect core banking platforms and digital channels with strong security and uptime." },
  { Icon: IconGovernance, accent: PURPLE, title: "Governance, risk & compliance visibility", desc: "Gain end-to-end visibility into controls, obligations, and regulatory requirements." },
  { Icon: IconIdentity, accent: CYAN, title: "Identity, fraud & access oversight", desc: "Strengthen identity controls and fraud detection across customers, employees, and third parties." },
  { Icon: IconAuditReport, accent: PURPLE, title: "Audit evidence & executive reporting", desc: "Consolidate evidence and deliver clear, board-ready reports with confidence." },
];

const DELIVERY = [
  { title: "Discover", weeks: "Weeks 1–2", desc: "Assess systems, risks, controls, and regulatory context." },
  { title: "Design", weeks: "Weeks 3–4", desc: "Define target state, controls, and roadmap." },
  { title: "Implement", weeks: "Weeks 5–10", desc: "Deploy controls, integrations, and reporting capabilities." },
  { title: "Operate", weeks: "Weeks 11–14", desc: "Monitor, optimise, and evolve resilience and risk management." },
];

const DELIVERABLES = [
  { t: "Control matrix", c: CYAN },
  { t: "Third-party risk view", c: PURPLE },
  { t: "Critical systems map", c: CYAN },
  { t: "Audit & evidence pack", c: PURPLE },
  { t: "Compliance obligations register", c: CYAN },
  { t: "Executive resilience dashboard", c: PURPLE },
];

const ENABLEMENT = [
  { n: 5, Icon: IconLayers, accent: PURPLE, title: "Framework alignment & automation", desc: "Align to ISO 27001, NIST, PCI DSS, and local regulations with automation that reduces manual effort and risk." },
  { n: 6, Icon: IconHandshake, accent: CYAN, title: "Board-ready reporting & training", desc: "Deliver executive dashboards, committee packs, and role-based training to strengthen oversight and culture." },
];

const panelCls =
  "rounded-large border border-[var(--border-default)] bg-[rgba(7,14,34,0.5)] p-6 md:p-7 h-full flex flex-col";

export default function BankingWhatYouGet() {
  return (
    <section className="py-12 md:py-16 section-rule" aria-labelledby="banking-wyg-heading">
      <Container>
        {/* Header */}
        <div className="border-l-2 border-[var(--purple)] pl-5 mb-9">
          <h2 id="banking-wyg-heading" className="text-[clamp(32px,4vw,52px)] font-extrabold leading-[1.02] tracking-tight text-[var(--text-primary)] mb-3">
          ...
          <p className="text-[14px] md:text-[15px] text-[var(--text-secondary)] leading-relaxed max-w-[560px]">
            Outcomes, delivery workstreams, and the operating layer that helps banking teams secure,
            ...
            <div className="flex-1 flex flex-col justify-center">
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="sm:w-[52%] flex flex-col items-center justify-center gap-5">
                  <Image
                    src="/images/banking-delivery.png"
                    alt="Banking delivery model illustration with dashboards, charts, and a bank"
                    width={1000}
                    height={1000}
