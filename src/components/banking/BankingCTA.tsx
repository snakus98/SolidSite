...
const STEPS = [
  { Icon: IconPeople, accent: CYAN, text: "Share your scope, systems, and regulatory priorities." },
  { Icon: IconRoadmap, accent: PURPLE, text: "We map a phased roadmap covering controls, resilience, fraud, and reporting." },
...
export default function BankingCTA() {
  return (
    <section className="py-12 md:py-16" aria-labelledby="banking-cta-heading">
      <Container>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
              ...
              <div className="lg:border-l lg:border-[var(--border-default)] lg:pl-12">
                ...
                <form className="space-y-5">
                  <div>
                    <label htmlFor="banking-name" className="block text-[14px] text-[var(--text-secondary)] mb-2">Full name</label>
                    <input id="banking-name" name="name" type="text" placeholder="Enter your full name" className={inputCls} />
                  </div>
                  <div>
                    <label htmlFor="banking-email" className="block text-[14px] text-[var(--text-secondary)] mb-2">Work email</label>
                    <input id="banking-email" name="email" type="email" placeholder="Enter your work email" className={inputCls} />
                  </div>
                  <div>
                    <label htmlFor="banking-session" className="block text-[14px] text-[var(--text-secondary)] mb-2">Book a session</label>
                    <div className="relative">
                      <select id="banking-session" name="session" defaultValue="" className={`${inputCls} appearance-none pr-10 cursor-pointer`}>
