...
function IconShield({ c }: { c: string }) {
  return (
    <svg viewBox="0 0 48 48" className="w-full h-full">
      <path d="M24 6 L38 11 V23 C38 33 24 42 24 42 C24 42 10 33 10 23 V11 Z" {...stroke(c)} />
      <path d="M17 24 l5 5 l9 -11" {...stroke(c)} />
    </svg>
  );
}
...
const STEPS = [
  { Icon: IconPeople, accent: CYAN, text: "Share your facilities, critical systems and regulatory pressures—we handle the rest." },
  { Icon: IconShield, accent: PURPLE, text: "You receive a phased roadmap covering Article 21 measures, clinical safeguards and board reporting." },
  { Icon: IconDocCheck, accent: CYAN, text: "Leave with a costed proposal your executives and regulators can endorse." },
];
...
export default function HealthcareCTA() {
  return (
    <section className="py-12 md:py-16" aria-labelledby="hc-cta-heading">
      <Container>
          ...
          <div className="rounded-large bg-[#040b1e] px-7 py-9 md:py-12 md:pl-7 md:pr-12">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
              ...
              <div className="flex flex-col border-l-2 border-[var(--purple)] pl-6">
                ...
                >
                  Plan your NIS2 healthcare programme with specialists who understand clinical constraints.
                </h2>
              ...
              <div className="lg:border-l lg:border-[var(--border-default)] lg:pl-12">
                ...
                <form className="space-y-5">
                  <div>
                    <label htmlFor="hc-name" className="block text-[14px] text-[var(--text-secondary)] mb-2">Full name</label>
                    <input id="hc-name" name="name" type="text" placeholder="Enter your full name" className={inputCls} />
                  </div>
                  <div>
                    <label htmlFor="hc-email" className="block text-[14px] text-[var(--text-secondary)] mb-2">Work email</label>
                    <input id="hc-email" name="email" type="email" placeholder="Enter your work email" className={inputCls} />
                  </div>
                  <div>
                    <label htmlFor="hc-session" className="block text-[14px] text-[var(--text-secondary)] mb-2">Book a session</label>
                    <div className="relative">
                      <select id="hc-session" name="session" defaultValue="" className={`${inputCls} appearance-none pr-10 cursor-pointer`}>
                  ...
                  >
                    ...
                    Book 30-min healthcare security consult
                  </Link>
                </form>
              </div>
            </div>
